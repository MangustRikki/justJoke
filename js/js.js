...
function adviceCreation() {
    ...
    const phrase1 = ["Просто", "Закройся в комнате,", "Выключи телефон и соцсети", "Открой свой третий глаз и", "Расслабься и", "Установи связь со своим высшым Я и", "Отбрось все мысли о сущем и", ""];
